...
struct FSynth1PatchCable
{
	...
	unsigned char                                      UnknownData_FQDD[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FEpicSynth1Patch
{
	...
	unsigned char                                      UnknownData_5CHV[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModularSynthPreset : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_LQWL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RQFN[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RMCW[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KJ2S[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LGUH[0x1];                                     // 0x0057(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1KFY[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H8YQ[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0WF[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QF3L[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EWT6[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_13PH[0x3];                                     // 0x00A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PMEJ[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7KIH[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YOFA[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_1JTY[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AVM2[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectEnvelopeFollowerSettings
{
	...
	unsigned char                                      UnknownData_AZZW[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectEQBand
{
	...
	unsigned char                                      UnknownData_CQ65[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_SZD6[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectMidSideSpreaderSettings
{
	...
	unsigned char                                      UnknownData_FF1J[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0CW3[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectPhaserSettings
{
	...
	unsigned char                                      UnknownData_OYYE[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectRingModulationSettings
{
	...
	unsigned char                                      UnknownData_VHAH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Frequency;                                                 // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FSourceEffectSimpleDelaySettings
{
	...
	unsigned char                                      UnknownData_O1IN[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectStereoDelaySettings
{
	...
	unsigned char                                      UnknownData_89JG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectConvolutionReverbSettings
{
	...
	unsigned char                                      UnknownData_MNDZ[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TTLG[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FSubmixEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_LIQZ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTapDelayInfo
{
	...
	unsigned char                                      UnknownData_FNSF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSynth2DSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_L8CU[0x4];                                     // 0x02DC(0x0004) MISSED OFFSET (PADDING)
...
struct FSynthKnobStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_ZJQS[0x7];                                     // 0x0251(0x0007) MISSED OFFSET (PADDING)
...
struct FSynthSlateStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_1CHM[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
