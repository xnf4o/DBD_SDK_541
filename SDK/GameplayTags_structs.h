...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_YJ56[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_0VA6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagTableRow : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_HZ6I[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_O1JH[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JRUC[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3IQK[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YP1I[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
