...
public:
	...
	unsigned char                                      UnknownData_OKY0[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_41AT[0x18];                                    // 0x0040(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QA4G[0x20];                                    // 0x0060(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IQBW[0x88];                                    // 0x0088(0x0088) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1GVC[0x70];                                    // 0x0110(0x0070) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9JQ4[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PWVZ[0x3];                                     // 0x00C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0965[0x3];                                     // 0x00CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MO14[0x3];                                     // 0x00CD(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_PUH3[0xC];                                     // 0x00D4(0x000C) MISSED OFFSET (PADDING)
