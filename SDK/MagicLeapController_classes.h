...
{
public:
	unsigned char                                      UnknownData_OAIH[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_APBG[0x58];                                    // 0x00F0(0x0058) MISSED OFFSET (PADDING)
