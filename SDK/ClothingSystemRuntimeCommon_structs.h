...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_2E3Q[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (PADDING)
...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_HSYZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_US72[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_P3YE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MF3U[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
