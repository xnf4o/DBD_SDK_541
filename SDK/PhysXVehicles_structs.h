...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_ELAE[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_S4YL[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_C0MN[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_PBR9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_6QSH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7ULR[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JATG[0x18];                                    // 0x00D0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6H47[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)
