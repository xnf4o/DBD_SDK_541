...
public:
	...
	unsigned char                                      UnknownData_L0O0[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L5ZV[0x7];                                     // 0x0161(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WFPV[0x8];                                     // 0x0178(0x0008) MISSED OFFSET (PADDING)
