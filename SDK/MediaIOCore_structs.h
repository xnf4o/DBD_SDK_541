...
struct FMediaCaptureOptions
{
	...
	unsigned char                                      UnknownData_DP95[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YJUC[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FMediaIOConnection
{
	...
	unsigned char                                      UnknownData_2SAZ[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_HM1M[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOMode
{
	...
	unsigned char                                      UnknownData_UNUQ[0x3];                                     // 0x0010(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOConfiguration
{
	...
	unsigned char                                      UnknownData_DRA6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMediaIOOutputConfiguration
{
	...
	unsigned char                                      UnknownData_EPFV[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_81CG[0x3];                                     // 0x004C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMediaIOInputConfiguration
{
	...
	unsigned char                                      UnknownData_4VTQ[0x3];                                     // 0x0044(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                KeyPortIdentifier;                                         // 0x0048(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
