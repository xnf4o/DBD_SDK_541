...
struct FARFilter
{
	...
	unsigned char                                      UnknownData_62NX[0x50];                                    // 0x0040(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QS8B[0x5];                                     // 0x00E3(0x0005) MISSED OFFSET (PADDING)
...
struct FAssetBundleEntry
{
	...
	unsigned char                                      UnknownData_ES6F[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAssetData
{
	...
	unsigned char                                      UnknownData_OIPZ[0x2C];                                    // 0x003C(0x002C) MISSED OFFSET (PADDING)
...
struct FTagAndValue
{
	...
	unsigned char                                      UnknownData_W5N8[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
