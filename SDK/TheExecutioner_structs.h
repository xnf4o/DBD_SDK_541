...
struct FAgonyDisplayFxEvent
{
	...
	unsigned char                                      UnknownData_O7BE[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8WS4[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FSpawnedAttackPoint
{
	...
	unsigned char                                      UnknownData_03YN[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V1QB[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WGMY[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1E3E[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FSpawnedTormentTrailPoint
{
	...
	unsigned char                                      UnknownData_ZFQF[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
