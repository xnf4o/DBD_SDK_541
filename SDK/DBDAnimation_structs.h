...
struct FFootBoneData
{
	...
	unsigned char                                      UnknownData_EWLH[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YLYR[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
