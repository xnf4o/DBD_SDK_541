...
{
	unsigned char                                      UnknownData_7JG9[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NWNM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
