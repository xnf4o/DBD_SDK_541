...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_DQ3G[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenuEntry
{
	...
	unsigned char                                      UnknownData_U7SH[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OU55[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_24D3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KFJS[0xE0];                                    // 0x0110(0x00E0) MISSED OFFSET (PADDING)
