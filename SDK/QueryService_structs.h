...
{
	unsigned char                                      UnknownData_SDTR[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MA8F[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DF2O[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SNHT[0x3];                                     // 0x0065(0x0003) MISSED OFFSET (PADDING)
...
struct FActorsInRangeBool
{
	...
	bool                                               _inRange;                                                  // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_Y9B4[0x23];                                    // 0x001D(0x0023) MISSED OFFSET (PADDING)
