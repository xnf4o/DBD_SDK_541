...
{
	unsigned char                                      UnknownData_TWJX[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FLevelSequenceObject
{
	...
	unsigned char                                      UnknownData_SZHM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequenceSnapshotSettings
{
	...
	unsigned char                                      UnknownData_L4NC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSequencePlayerSnapshot
{
	...
	unsigned char                                      UnknownData_A1AC[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_515A[0x4];                                     // 0x00BC(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_THZA[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0VPT[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
