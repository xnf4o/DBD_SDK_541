...
{
public:
	unsigned char                                      UnknownData_0GU8[0x24];                                    // 0x00B8(0x0024) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GSK8[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_0KZL[0x8];                                     // 0x00E8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTAT[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EXGG[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SPKN[0x3];                                     // 0x0129(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTIM[0x4];                                     // 0x0144(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EQ4O[0x3F];                                    // 0x0159(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SH1O[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_S70C[0x8];                                     // 0x0048(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_3QG7[0x53];                                    // 0x00FD(0x0053) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6RPE[0x8];                                     // 0x0230(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GWCR[0x3];                                     // 0x02D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPB7[0x3];                                     // 0x02D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LGPX[0xE0];                                    // 0x02E0(0x00E0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8GVL[0x58];                                    // 0x03D0(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V5MH[0x10];                                    // 0x0078(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MDUB[0x2F];                                    // 0x00B1(0x002F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_QQ4A[0x8];                                     // 0x0238(0x0008) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_R9ZW[0x3F];                                    // 0x0051(0x003F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_64CQ[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K6OB : 1;                                      // 0x0080(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_VA0A[0x2];                                     // 0x0082(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HGTJ[0x3];                                     // 0x0085(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MKWK[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Z7Q[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V4I5[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UKQC[0xE8];                                    // 0x00F8(0x00E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4Z2P[0x35B];                                   // 0x01E1(0x035B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XU1K[0x20];                                    // 0x0540(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KHLX[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2D7H[0x10];                                    // 0x0230(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G468[0x7];                                     // 0x0251(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_75DH[0x4];                                     // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QU8S[0x3];                                     // 0x02B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GT69[0x3];                                     // 0x02C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_93RI[0x3];                                     // 0x02C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5OGX[0x3];                                     // 0x02D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UI49[0x30];                                    // 0x02F8(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3WMV[0x8];                                     // 0x0428(0x0008) Fix Super Size
...
{
public:
	unsigned char                                      UnknownData_4F7W[0x8];                                     // 0x0428(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_IYD9[0x4];                                     // 0x026C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Y52J[0x8];                                     // 0x0428(0x0008) Fix Super Size
	unsigned char                                      UnknownData_XXQI[0x10];                                    // 0x0430(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DE4Z[0x8];                                     // 0x0268(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_0GJ5[0x6];                                     // 0x023A(0x0006) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BI2B[0x8];                                     // 0x0428(0x0008) Fix Super Size
...
public:
	...
	unsigned char                                      UnknownData_0CW0[0x1];                                     // 0x042B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6NIV[0x3];                                     // 0x0431(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HWGQ[0x2];                                     // 0x0492(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6SFB[0x2];                                     // 0x049E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V2U8[0x34];                                    // 0x04AC(0x0034) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_ZCZQ[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)
