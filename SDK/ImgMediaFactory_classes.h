...
public:
	...
	unsigned char                                      UnknownData_NSOB[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WCPN[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BK9V[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)
