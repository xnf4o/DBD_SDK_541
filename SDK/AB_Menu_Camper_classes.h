...
public:
	...
	unsigned char                                      UnknownData_NZ0R[0x3];                                     // 0x1A81(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LIIM[0x2];                                     // 0x1A8E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
