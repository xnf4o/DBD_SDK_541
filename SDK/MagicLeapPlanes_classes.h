...
public:
	...
	unsigned char                                      UnknownData_6V58[0x3];                                     // 0x0235(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XCNV[0x4];                                     // 0x023C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R82Q[0x20];                                    // 0x0260(0x0020) MISSED OFFSET (PADDING)
