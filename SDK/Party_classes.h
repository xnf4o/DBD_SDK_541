...
public:
	...
	unsigned char                                      UnknownData_OLT6[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7SX3[0x20];                                    // 0x0030(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VYGW[0x140];                                   // 0x0068(0x0140) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K4MJ[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_28UZ[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VHO6[0x7F];                                    // 0x0121(0x007F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y0K3[0x10];                                    // 0x01A8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9II0[0x100];                                   // 0x01C0(0x0100) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LJLD[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ND8K[0x80];                                    // 0x0078(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_INQL[0x38];                                    // 0x0030(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3AQB[0x50];                                    // 0x0080(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BSS2[0x118];                                   // 0x00E0(0x0118) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L6XA[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FDBL[0x7];                                     // 0x0171(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*> GroupChannels;                                             // 0x0178(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_VZDI[0x60];                                    // 0x01C8(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_1G8N[0xC0];                                    // 0x0030(0x00C0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KO85[0x10];                                    // 0x00F0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_UB9I[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0Y37[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ZA6R[0x1];                                     // 0x0047(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4W42[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FYS2[0x140];                                   // 0x0030(0x0140) MISSED OFFSET (PADDING)
