...
public:
	...
	unsigned char                                      UnknownData_TT97[0x9C];                                    // 0x0044(0x009C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3AXV[0x390];                                   // 0x0030(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03C0(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5V9G[0x8];                                     // 0x03D0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QMDA[0x148];                                   // 0x03DC(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HHVD[0x1E4];                                   // 0x052C(0x01E4) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_7FS0[0xA4];                                    // 0x0044(0x00A4) MISSED OFFSET (PADDING)
