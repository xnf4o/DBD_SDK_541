...
public:
	...
	unsigned char                                      UnknownData_JRI0[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_XU8I[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LXHW[0x88];                                    // 0x0060(0x0088) MISSED OFFSET (PADDING)
