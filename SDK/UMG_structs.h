...
struct FNamedSlotBinding
{
	...
	unsigned char                                      UnknownData_XATC[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_DO83[0x4];                                     // 0x0008(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_ZMTD[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A2EV[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_1QCT[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_YW9T[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_91EQ[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_IEVQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_SJV2[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_V2Q1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4TLC[0x4];                                     // 0x0018(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FEventReply
{
	unsigned char                                      UnknownData_0ICK[0xC0];                                    // 0x0000(0x00C0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U2IH[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_66SZ[0x3];                                     // 0x04B9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_TRKN[0x7];                                     // 0x02D9(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_USUU[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
