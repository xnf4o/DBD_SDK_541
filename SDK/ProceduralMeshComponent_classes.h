...
{
public:
	unsigned char                                      UnknownData_9VP5[0x8];                                     // 0x0478(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_S81V[0x6];                                     // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9RT9[0x4];                                     // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
