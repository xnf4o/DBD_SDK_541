...
public:
	...
	unsigned char                                      UnknownData_EKR9[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AOC4[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Z6L5[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_XSPD[0x30];                                    // 0x0080(0x0030) MISSED OFFSET (PADDING)
