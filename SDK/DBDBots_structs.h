...
struct FAIGoalWeight
{
	...
	unsigned char                                      UnknownData_306C[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRelevantNodeMemory
{
	...
	unsigned char                                      UnknownData_YJXM[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FMindFocusObjectEntry
{
	...
	unsigned char                                      UnknownData_LUK2[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FName, float>                          CooldownMap;                                               // 0x0018(0x0050) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CL8Z[0x10];                                    // 0x0068(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KA8U[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FNavLinkInteractPlayerSetup
{
	...
	unsigned char                                      UnknownData_1SUI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FLXK[0x24];                                    // 0x0000(0x0024) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G6RV[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
