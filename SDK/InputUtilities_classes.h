...
{
public:
	unsigned char                                      UnknownData_6IHY[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_TQ5D[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NJTO[0x20];                                    // 0x00D8(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_L4PW[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JGXU[0x28];                                    // 0x0060(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0579[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_WSK3[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)
