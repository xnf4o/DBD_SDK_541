...
public:
	...
	unsigned char                                      UnknownData_QROY[0x69C];                                   // 0x06F4(0x069C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8UHD[0x30];                                    // 0x0048(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_XCJ8[0x40];                                    // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_U0PU[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ZOXS[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7PC8[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_SJN2[0x38];                                    // 0x0048(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_DQ2U[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_BJTJ[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_1GJC[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_E2EO[0x30];                                    // 0x0048(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_WMQV[0x38];                                    // 0x0048(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_BE52[0x3C];                                    // 0x0048(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_JI3S[0x40];                                    // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_JDML[0x3C];                                    // 0x0048(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_YZK9[0x30];                                    // 0x0048(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_OBSK[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_DWL0[0x4E];                                    // 0x0072(0x004E) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2XVH[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XB6R[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V2KA[0x34];                                    // 0x0048(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_3RR8[0x38];                                    // 0x0048(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_0RE8[0x40];                                    // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectTapDelaySettings               Settings;                                                  // 0x0088(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_HFDI[0x18];                                    // 0x00A0(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_4AYQ[0x4];                                     // 0x0130(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_WGI1[0x4];                                     // 0x0144(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_PRJY[0x2];                                     // 0x044A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WCRV[0x7];                                     // 0x0451(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WL56[0x10];                                    // 0x04B8(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_9Z54[0x3B8];                                   // 0x06F8(0x03B8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_P1EP[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V2H5[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_U6IC[0x117];                                   // 0x0061(0x0117) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_0D5Y[0x718];                                   // 0x0718(0x0718) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_1S4U[0x108];                                   // 0x0718(0x0108) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_X5FE[0x7];                                     // 0x0139(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BQ1A[0x4];                                     // 0x0170(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_FFK9[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEN4[0x6];                                     // 0x03E2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XNOZ[0x10];                                    // 0x0438(0x0010) MISSED OFFSET (PADDING)
