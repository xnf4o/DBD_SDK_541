...
struct FSubmixEffectDynamicProcessorFilterSettings
{
	...
	unsigned char                                      UnknownData_04T0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_7518[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DQFO[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C513[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      UnknownData_AB7N[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubmixEffectReverbFastSettings
{
	...
	unsigned char                                      UnknownData_PZ3J[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
