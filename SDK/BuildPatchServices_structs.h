...
struct FFileManifestData
{
	...
	unsigned char                                      UnknownData_KEJL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P9IF[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XKQ2[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
struct FChunkInfoData
{
	...
	unsigned char                                      UnknownData_48MH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1RHX[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
