...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_UK7A[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_23RQ[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_BF7V[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_57WR[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_69YA[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_JB3Z[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_ONFW[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_NOGH[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_NEV1[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_SGO5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MLFF[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F6YJ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_TK5R[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_P6NX[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_72PC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_I754[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_AEGC[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_OW1K[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_5NNT[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_75I8[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_4W39[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_FMMS[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_AJKJ[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_GTBY[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkWindowsAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_55TU[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkWinGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_WOCD[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_M8XA[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Q2U1[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXSXAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YE4J[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_MTFY[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_VMKP[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_8WAM[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_ODJX[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QUAK[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2BQL[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YMH8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_D2WO[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EADJ[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_FJE7[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
