...
{
public:
	unsigned char                                      UnknownData_TWPY[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2H3K[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
