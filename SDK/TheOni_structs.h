...
{
	unsigned char                                      UnknownData_FCAY[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAccumulator
{
	unsigned char                                      UnknownData_W4ST[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_U9EJ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
