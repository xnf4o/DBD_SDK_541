...
public:
	...
	unsigned char                                      UnknownData_FEPZ[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MK20[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (PADDING)
