...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_55QH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_A4H3[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_YMHU[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_IU5J[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A8JN[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4PT9[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I8HH[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LPR0[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_93XQ[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EUMD[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X2BZ[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_GD55[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_JRUS[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChaosCollisionEventData
{
	...
	unsigned char                                      UnknownData_KTHP[0x14];                                    // 0x0044(0x0014) MISSED OFFSET (PADDING)
